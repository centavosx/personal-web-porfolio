...
const buttonVariantClasses = {
  ...
  icon: "rounded-lg bg-icon py-2 px-4 border border-transparent text-center transition-all shadow-md disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none hover:scale-105 active:scale-100 duration-300",
  transparent:
